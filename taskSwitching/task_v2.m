%% KEYS used: G&H; Single hand with Practice trials
...
try
    ...
    leftKey     = KbName('g'); % key- g // Replace with '/?' for bimanual one finger
    rightKey    = KbName('h'); % key- h // Replace with 'z' for bimanual one finger
    ...
    instructions1 = {
        ...
        ''
        ''
        'We''ll start with small training'
    ...
    instructions2 = {
      ...
      ''
      'Use key ''G'' to report an ODD number'
      ''
      'Use key ''H'' to report an EVEN number'
      ''
      ''
    ...
    instructions3 = {
      ...
      ''
      'Use key ''G'' to report a Consonant'
      ''
      'Use key ''H'' to report an Vowel'
      ''
      ''
      'Press ''Left Shift'' to begin' 
    };
    instructions4 = {
      ...
      ''
      'Use key ''G'' to report a ODD / CONSONANT'
      ''
      'Use key ''H'' to report an EVEN / VOWEL'
      ''
      ''
      'Press ''Left Shift'' to begin' 
    };
